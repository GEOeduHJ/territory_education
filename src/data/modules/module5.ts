...
export const MODULE_5_DATA: ModuleData = {
  ...
  description: "제주 예멘 난민 사례를 중심으로, 다양한 이해관계자의 페르소나 챗봇과 대화하며 경계 문제의 복잡성을 이해하고, 세계시민의 관점에서 갈등을 중재하는 모듈",
  steps: [
    {
      id: "step-1",
      title: "📺 AI 뉴스 영상 학습",
    ...
    },
    {
      ...
      content: "이제 실제 국제회의에 참여할 시간입니다! \nAI 없이 진행되는 토론에서 여러분이 준비한 입장을 발표하고, 다른 참가자들과 건설적인 토론을 진행해보세요. \n상호 존중과 이해를 바탕으로 한 의미 있는 대화를 나누어보겠습니다. 🤝\n\n작성한 입장문을 아래의 국제회의장 패들렛에 공유해보세요. \n다른 참석자들의 입장문을 읽고, 최소 3개 이상의 입장문에 댓글 또는 반응을 남겨 의견을 교환해보세요.",
      externalLinks: [
        {
