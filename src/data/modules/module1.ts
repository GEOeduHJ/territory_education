...
다윗: 맞아. 나일강이 어느 한 나라만의 강이 아니라 함께 살아가는 강이라는 메시지를 노래에 담아 보자.`
  }
  // {
  //   "id": "region-8",
  //   "name": "이집트-수단(할라이브)",
  ...
  // }
    ...
    2) 학습자가 분석한 아래 내용을 가사에 반영할 것.
    3) 특정 국가, 민족, 종교를 비난하지 말 것.
    4) 한쪽 입장만 옳다고 단정하지 말 것.
    5) 평화, 공존, 협력의 메시지가 드러나도록 작성할 것.
