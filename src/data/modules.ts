import { ModuleConfig, ModuleKeywordConfig } from '../types';
...
export const MODULES_DATA: ModuleConfig = {
  modules: {
    ...
    "2": {
      id: "2",
      title: "여기를 수정하세요 - 영토교육 모듈 2",
      description: "여기를 수정하세요 - 두 번째 영토교육 모듈 설명",
      steps: [
        {
          id: "step-1",
          title: "여기를 수정하세요 - 단계 1",
          description: "여기를 수정하세요 - 단계 1 설명",
        ...
        },
        {
          ...
          description: "여기를 수정하세요 - 단계 2 설명",
          content: "여기를 수정하세요 - 단계 2 상세 내용",
          externalLink: {
            url: "https://example.com/module2-step2",
            label: "여기를 수정하세요 - 외부 자료",
            openInNewTab: true
          },
          editableContent: true
        },
    ...
    "3": {
      id: "3",
      title: "여기를 수정하세요 - 영토교육 모듈 3",
      description: "여기를 수정하세요 - 세 번째 영토교육 모듈 설명",
      steps: [
        {
          id: "step-1",
          title: "여기를 수정하세요 - 단계 1",
        ...
        },
        {
          ...
          content: "여기를 수정하세요 - 단계 3 상세 내용",
          externalLink: {
            url: "https://example.com/module3-step3",
            label: "여기를 수정하세요 - 참고 자료",
            openInNewTab: true
          },
          editableContent: true
        },
    ...
    "4": {
      id: "4",
      title: "여기를 수정하세요 - 영토교육 모듈 4",
      description: "여기를 수정하세요 - 네 번째 영토교육 모듈 설명",
      steps: [
        {
          id: "step-1",
          title: "여기를 수정하세요 - 단계 1",
        ...
        },
        {
          ...
          content: "여기를 수정하세요 - 단계 4 상세 내용",
          externalLink: {
            url: "https://example.com/module4-step4",
            label: "여기를 수정하세요 - 실습 자료",
            openInNewTab: true
          },
          editableContent: true
        },
    ...
    "5": {
      id: "5",
      title: "여기를 수정하세요 - 영토교육 모듈 5",
      description: "여기를 수정하세요 - 다섯 번째 영토교육 모듈 설명",
      steps: [
        {
          id: "step-1",
          title: "여기를 수정하세요 - 단계 1",
        ...
        },
        {
          ...
          content: "여기를 수정하세요 - 단계 5 상세 내용",
          externalLink: {
            url: "https://example.com/module5-step5",
            label: "여기를 수정하세요 - 최종 점검",
            openInNewTab: true
          },
          editableContent: true
        }
    ...
    "6": {
      ...
      steps: [
        ...
        },
        {
          ...
          content: "여기를 수정하세요 - 단계 5 상세 내용",
          externalLink: {
            url: "https://example.com/module6-final",
            label: "여기를 수정하세요 - 종합 평가",
            openInNewTab: true
          },
          editableContent: true
        }
